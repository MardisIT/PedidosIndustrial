...
public class Daoreporteitem implements DaoInterface<reporteitem>  {
    ...
    public List <reportepedidosE> reportepedidosES(){
        ...
        String sql = "SELECT r.codproducto,a.descripcion, sum(r.cantidad),r.unidades,r.precio,r.total FROM reporteitem r  inner join articulos a on a.idArticulo=r.codproducto  group by r.codproducto " ;
